...
export const ProductDrawerForm: React.FC<Props> = (props) => {
  ...
  console.log("ProductDrawerForm props:", props);
  console.log("ProductDrawerForm formprops:", formProps);
  ...
  const title =
    props.action === "edit" ? undefined : t("products.actions.add") ?? "Add Product";
    ...
    >
      <Spin spinning={formLoading}>
        ...
        >
            ...
            >
              ...
              >
                <Avatar
                  ...
                  src={previewImageURL || "/images/product-default.png"}
                />
                <Button icon={<UploadOutlined />} style={{ marginTop: 16 }}>
                  {t("products.fields.images.placeholder") ?? "Upload cover"}
                </Button>
              </Flex>
            </Upload.Dragger>
          </Form.Item>
          ...
          {/* Authors */}
          <Form.Item
            label={t("products.fields.authors")}
            name="authors"
            rules={[
          ...
          <Flex style={{ gap: 16 }}>
            ...
            <Form.Item
              label={t("products.fields.originalPrice")}
              name="originalPrice"
              rules={[{ required: true }]}
            >
              <InputNumber prefix="$" style={{ width: "100%" }} min={0} />
          ...
          {/* Condition & Stock */}
          <Flex style={{ gap: 16 }}>
            <Form.Item label={t("products.fields.condition")} name="condition">
              {/*<Segmented*/}
              {/*    options={[*/}
              {/*        { label: "NEW", value: "NEW" },*/}
              ...
              <Segmented
                options={[
                  {
                    label: t("products.fields.condition.options.new", "NEW"),
                    value: "NEW",
                  },
                  {
                    label: t(
                      "products.fields.condition.options.likeNew",
                      "LIKE NEW"
                    ),
                    value: "LIKE NEW",
                  },
                  {
                    label: t("products.fields.condition.options.good", "GOOD"),
                    value: "GOOD",
                  },
                  {
                    label: t(
                      "products.fields.condition.options.acceptable",
                      "ACCEPTABLE"
                    ),
                    value: "ACCEPTABLE",
                  },

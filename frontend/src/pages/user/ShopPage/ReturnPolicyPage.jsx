...
export default function ReturnPolicyPage() {
    const {
        ...
        queryKey: ["staticPage", "return-policy"],
        queryFn: () => fetchStaticPageBySlug("return-policy"),
        ...
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-gray-600">Return policy content is not available at the moment.</p>
                </div>
            </div>
        )
    }
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <article className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
                    <div className="bg-gradient-to-r from-[#7f1c1c] to-[#5f1515] px-8 lg:px-12 py-12 text-center">
                        <h1 className="text-3xl lg:text-4xl font-bold text-white mb-4 leading-tight">{returnsContent.title}</h1>
                    ...
                    <div className="p-8 lg:p-12">
                        <div className="prose prose-lg max-w-none">
                            <div
                                className="text-gray-800 leading-relaxed whitespace-pre-wrap text-lg">{returnsContent.content}</div>
                        </div>

                        {returnsContent.lastModified && (
                            <div className="mt-12 pt-8 border-t border-gray-100">
                                <div className="flex items-center justify-end text-sm text-gray-500">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span>
                      Last updated:{" "}
                                            {new Date(returnsContent.lastModified).toLocaleDateString("en-US", {
                                                year: "numeric",
                                                month: "long",
                                                day: "numeric",
                                                hour: "2-digit",
